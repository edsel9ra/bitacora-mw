    ...
    if ($chetanoSedes !== []) {
        foreach ($sections as &$section) {
            ...
            $chetanoFields = [
                ...
                app_bitacora_field('multiselect', 'formatos_chetano', 'FORMATOS DILIGENCIADOS DURANTE LA JORNADA', ['col' => 'col-md-6', 'options' => $formatosChetano, 'sedes' => $chetanoSedes, 'required' => false]),
