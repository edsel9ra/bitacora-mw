        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="jumbotron" style="background:#f0f2f5">
                    <?php echo app_logout_form('btn btn-danger btn-block-sm', 'Cerrar Sesión'); ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="container d-flex justify-content-center mt-2 mb-2">
                                ...
                                <div class="form-group col-md-5">
                                    <label for="bar"><b><span style="color:#FF0000" ;>•</span> Devoluciones de Producto (Retorno a Cocina)<span style="color:#FF0000" ;>*</span></b></label>
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <div class="row mt-2 mb-2">
                                    <div class="col-md-6">
                                        <fieldset class="mb-2">
                                          <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se presento algún incidente o accidente durante la jornada laboral? 
                                            Los accidentes pueden ser tanto laborales como accidentes de tránsito.<span style="color:#FF0000">*</span></b>
                                          </legend>
                                          <div class="form-check form-check-inline">
                                        ...
                                        <div id="sst1Group" class="mt-2" style="display:none;">
                                          <label for="sst1" class="form-label"><strong>Ingrese los incidentes, accidentes laborales y accidentes de tránsito que se presentaron:</strong></label>
                                          <textarea class="form-control" rows="3" id="sst1" name="sst1"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="mb-2">
                                          <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Algún colaborador tiene incapacidad igual o mayor a 15 días?<span style="color:#FF0000">*</span></b>
                                          </legend>
                                          <div class="form-check form-check-inline">
                                        ...
                                        <div id="sst2Group" class="mt-2" style="display:none;">
                                          <label for="sst2" class="form-label"><strong>Ingrese las incapacidades iguales o mayores a 15 días:</strong></label>
                                ...
                                <div class="row mt-2 mb-2">
                                    <div class="col-md-6">
                                        <fieldset class="mb-2">
                                          <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se presento alguna novedad en el ambiente laboral? <span style="color:#FF0000">*</span></b>
                                          </legend>
                                          <div class="form-check form-check-inline">
                                        ...
                                        <div id="sst3Group" class="mt-2" style="display:none;">
                                          <label for="sst3" class="form-label"><strong>Ingrese los hallazgos por ambiente laboral:</strong></label>
                                          <textarea class="form-control" rows="3" id="sst3" name="sst3"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <fieldset class="mb-2">
                                          <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se ha presentado novedades con los extintores y la señalización?<span style="color:#FF0000">*</span></b>
                                          </legend>
                                          <div class="form-check form-check-inline">
                                        ...
                                        <div id="sst4Group" class="mt-2" style="display:none;">
                                          <label for="sst4" class="form-label"><strong>Ingrese los reportes de los extintores y avisos de señalización:</strong></label>
                                ...
                                <div class="mt-3 mb-3">
                                    <div class="container d-flex justify-content-center">
                                        <div class="form-group col-md-6">
                                            <label for="equipo_sst"><b><span style="color:#FF0000" ;>•</span> Ingrese si hubo visita por parte del equipo de
                                                    SST a la sede y las actividades realizadas. En caso de que no hayan visitado, seleccionar "No aplica visita".<span style="color:#FF0000" ;>*</span></b></label>
                                            <select id="equipo_sst" name="equipo_sst[]" multiple="multiple" style="width: 100%;" class="form-control" rows="3" required>
                                ...
                                <div class="row mt-2 mb-2">
                                    <div class="col-md-4">
                                        <fieldset class="mb-2">
                                          <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se realizó entrega de elementos de protección personal (EPP)? <span style="color:#FF0000">*</span></b>
                                          </legend>
                                          <div class="form-check form-check-inline">
                                        ...
                                        <div id="sst6Group" class="mt-2" style="display:none;">
                                          <label for="sst6" class="form-label"><strong>Ingrese las entregas realizadas de elementos de protección personal (EPP), especificar si fue por parte del personal del área o del proveedor:</strong></label>
                                          <textarea class="form-control" rows="3" id="sst6" name="sst6"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <fieldset class="mb-2">
                                          <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se presentaron otras novedades relacionadas con el área?<span style="color:#FF0000">*</span></b>
                                          </legend>
                                          <div class="form-check form-check-inline">
                                        ...
                                        <div id="sst7Group" class="mt-2" style="display:none;">
                                          <label for="sst7" class="form-label"><strong>Ingrese otras novedades como mantenimiento de alto riesgo, situaciones de salud, condiciones o actos inseguros, etc:</strong></label>
                                          <textarea class="form-control" rows="4" id="sst7" name="sst7"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <fieldset class="mb-2">
                                          <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se registraron solicitudes o casos en HelpDesk para el área de SST?<span style="color:#FF0000">*</span></b>
                                          </legend>
                                          <div class="form-check form-check-inline">
                                        ...
                                        <div id="sst8Group" class="mt-2" style="display:none;">
                                          <label for="sst8" class="form-label"><strong>Ingrese las solicitudes o los casos registrados y/o pendientes para el área:</strong></label>
                            ...
                            <div class="row mt-2 mb-2">
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo novedades con los equipos de Cocina? <span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="mantGroup" class="mt-2" style="display:none;">
                                      <label for="mant" class="form-label"><strong>Ingrese las novedades con los equipos de Cocina:</strong></label>
                                      <textarea class="form-control" rows="3" id="mant" name="mant"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo novedades con los equipos de Bar?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="mant1Group" class="mt-2" style="display:none;">
                                      <label for="mant1" class="form-label"><strong>Ingrese las novedades con los equipos de Bar:</strong></label>
                                      <textarea class="form-control" rows="4" id="mant1" name="mant1"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo novedades con los equipos de Salón?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="mant2Group" class="mt-2" style="display:none;">
                                      <label for="mant2" class="form-label"><strong>Ingrese las novedades con los equipos de Salón:</strong></label>
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <div class="container d-flex justify-content-center">
                                    <div class="form-group col-md-6">
                                        <label for="equipo_bpm"><b><span style="color:#FF0000" ;>•</span> Ingrese si hubo visita por parte del equipo de
                                                Mejoramiento a la sede y las actividades realizadas. En caso de que no hayan visitado, seleccionar "No aplica visita"<span style="color:#FF0000" ;>*</span></b></label>
                                        <select id="equipo_bpm" name="equipo_bpm[]" multiple="multiple" style="width: 100%;" class="form-control" rows="3" required>
                                    ...
                                    <div class="form-group col-md-6" style="display: none;" id="contenedor_bpm">
                                        <textarea class="form-control" rows="7" id="bpm" name="bpm"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-2 mb-2">
                                    ...
                                    <div class="col-md-6">
                                      <fieldset class="mb-2">
                                        <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo visita por parte del DAGMA?<span style="color:#FF0000">*</span></b>
                                        </legend>
                                ...
                                <div class="row mt-2 mb-2">
                                    <div class="col-md-4">
                                        <fieldset class="mb-2">
                                            <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo visita por parte de West - Klaxen?<span style="color:#FF0000">*</span></b>
                                            </legend>
                                    ...
                                    <div class="col-md-4">
                                        <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo entrega de residuos aprovechables al proveedor
                                                autorizado?<span style="color:#FF0000">*</span></b>
                                        </legend>
                                ...
                                <div class="row mt-2 mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se realizó control de plagas?<span style="color:#FF0000">*</span></b>
                                        </legend>
                            ...
                            <div class="container d-flex justify-content-center">
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo producción de bolsas de hielo?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="hieloGroup" class="mt-2" style="display:none;">
                                      <label for="hielo" class="form-label"><strong>Ingrese la producción de bolsas en el día:</strong></label>
                                      <input type="number" min="0" max="100" class="form-control" name="hielo" id="hielo">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se compró hielo a proveedor Kolbitos?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="hielo1Group" class="mt-2" style="display:none;">
                                      <label for="hielo1" class="form-label"><strong>Ingrese la cantidad de bolsas compradas:</strong></label>
                                      <input type="number" min="0" max="100" class="form-control" name="hielo1" id="hielo1">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se consumieron bolsas de hielo durante la operación del día?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="hielo2Group" class="mt-2" style="display:none;">
                                      <label for="hielo2" class="form-label"><strong>Ingrese el consumo de bolsas en el día:</strong></label>
                            ...
                            <div class="container d-flex justify-content-center">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="bar"><b><span style="color:#FF0000;">•</span> Inventario Final de bolsas de hielo en el día<span style="color:#FF0000;">*</span></b></label>
                                    <input type="number" min="0" max="100" class="form-control" name="hielo3" required></textarea>
                                </div>
                                
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se enviaron bolsas de hielo a otras sedes?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="hielo4Group" class="mt-2" style="display:none;">
                                      <label for="hielo4" class="form-label"><strong>Ingrese el número de bolsas que se enviaron y a que sedes:</strong></label>
                                      <textarea class="form-control" rows="3" id="hielo4" name="hielo4"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se solicitó bolsas de hielo a otras sedes?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="hielo5Group" class="mt-2" style="display:none;">
                                      <label for="hielo5" class="form-label"><strong>Ingrese el número de bolsas que se recibieron y de que sedes:</strong></label>
                            ...
                            <div class="row mt-2 mb-2">
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo facturas anuladas en mesas durante el día? <span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="fa_mesasGroup" class="mt-2" style="display:none;">
                                      <label for="fa_mesas" class="form-label"><strong>Ingrese las facturas anuladas en mesas:</strong></label>
                                      <textarea class="form-control" rows="3" id="fa_mesas" name="fa_mesas"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo facturas anuladas de Domicilios durante el día?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="fa_domGroup" class="mt-2" style="display:none;">
                                      <label for="mant1" class="form-label"><strong>Ingrese las facturas anuladas en domicilios:</strong></label>
                                      <textarea class="form-control" rows="3" id="fa_dom" name="fa_dom"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <fieldset class="mb-2">
                                      <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo facturas anuladas de Rappi durante el día?<span style="color:#FF0000">*</span></b>
                                      </legend>
                                      <div class="form-check form-check-inline">
                                    ...
                                    <div id="fa_rappiGroup" class="mt-2" style="display:none;">
                                      <label for="fa_rappi" class="form-label"><strong>Ingrese las facturas anuladas de Rappi:</strong></label>
            ...
            $(".form-bitacora").submit(function(event) {
              ...
              $.ajax({
                ...
                success: function(data) {
                  ...
                  // Restablecer componentes y select2
                  $('#contenedor_sup').hide();
                  $('#supervisores option').prop('disabled', false);
                  $('#supervisores').select2({
                    placeholder: "Seleccione uno o más supervisores que realizaron visita",
