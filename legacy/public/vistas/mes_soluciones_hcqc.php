                ...
                <div class="jumbotron" style="background:#f0f2f5">
                    ...
                    <form method="post" class="form-bitacora" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="mb-2">
                                  <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se realizó alguna reserva en donde hay entre 10 o más personas?<span
                                ...
                                <div id="mer4Group" class="mt-2" style="display:none;">
                                  <label for="mer4" class="form-label"><strong>Ingrese las reservas realizadas durante el día, con la información y contacto de los clientes:</strong></label>
                            ...
                            <!-- Modificación 25 de junio de 2025-->
                            <div class="mt-3 mb-3">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b>ÁREA
                            ...
                            <div class="mt-3 mb-2">
                              <label for="exampleFormControlTextarea1">
                                ...
                                <b>ÁREA DE BAR <span class="text-danger">*</span></b>
                              </label>
                              <small class="form-text fw-bold"></small>
                              <!-- Usamos row-cols para definir cuántas columnas por fila según el tamaño de pantalla,
                                   y g-4 para gutter (espacio) de 1.5rem entre filas y columnas -->
                              <div class="container d-flex justify-content-center">
                                <div class="col-md-4">
                                  <fieldset class="mb-2">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b> NOVEDADES DOMICILIOS
                                    / RAPPI<span style="color:#FF0000" ;>*</span></b></label>
                             </div>
                             
                             <div class="container d-flex justify-content-center">
                                <div class="form-group col-md-6">
                                <label for="bar"><b><span style="color:#FF0000" ;>•</span> Ingrese las novedades con Rappi.<span
                                      style="color:#FF0000" ;>*</span></b></label>
                                </br>
                                <textarea class="form-control" rows="3" name="dorp" required></textarea>
                              </div>
                              <div class="form-group col-md-6">
                                <label for="bar"><b><span style="color:#FF0000" ;>•</span> Ingrese las novedades con domicilios
                                    propios.<span style="color:#FF0000" ;>*</span></b></label>
                                </br>
                            ...
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="mb-2">
                                        <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se realizaron pagos por medio de EasyPedido?<span style="color:#FF0000">*</span></b>
                                        </legend>
                                    <div class="form-check form-check-inline">
                                    ...
                                    <div id="tesor2Group" class="mt-2" style="display:none;">
                                        <label for="tesor2" class="form-label"><strong>Ingrese los pedidos con su correspondiente valor:</strong></label>
