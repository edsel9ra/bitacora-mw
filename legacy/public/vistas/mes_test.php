        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="jumbotron" style="background:#f0f2f5">
                    ...
                    <hr class="my-4">
                    <br>
                    <form method="post" class="form-bitacora" data-action="../scripts/send_test.php" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="idSede" class="form-control" name="sede" required>
                                    ...
                                    <option value="JARDÍN PLAZA">JARDÍN PLAZA</option>
                            ...
                            <div class="container d-flex justify-content-center">
                                <div class="form-group col-md-6">
                                    <label for="supervisores"><b><span style="color:#FF0000" ;>•</span> Ingrese los supervisores que hayan visitado la sede en el día, las actividades realizadas, la hora de ingreso y la hora de salida. En caso de que no hayan visitado, seleccionar "No aplica visita"<span
                                    ...
                                    <select id="supervisores" name="supervisores[]" multiple="multiple" style="width: 100%;" class="form-control" rows="3" required>
                                        ...
                                        <option value="Maria Conchita Parra">Maria Conchita Parra - Entrenadora de Cocina y Bar</option>
                                ...
                                <div class="form-group col-md-6" style="display: none;" id="contenedor_sup">
                                    ...
                                    <div class="form-group col-md-5">
                                        <label for="supervisores"><b><span style="color:#FF0000" ;>•</span> Ingrese la hora de ingreso de la entrenadora/supervisora/coordinador<span
                                                style="color:#FF0000" ;>*</span></b></label>
                                        <input class="form-control" type="time" id="hora_entrada" name="hora_entrada" />
                                        <label for="supervisores"><b><span style="color:#FF0000" ;>•</span> Ingrese la hora de salida de la entrenadora/supervisora/coordinador<span
                                                style="color:#FF0000" ;>*</span></b></label>
                                  ...
                                  <div class="container d-flex justify-content-center">
                                    <div class="form-group col-md-6">
                                      ...
                                      <select id="equipo_sst" name="equipo_sst[]" multiple="multiple" style="width: 100%;"
                                        ...
                                        <option value="Julián Guzmán">Julián Guzmán - Auxiliar SST</option>
                            ...
                            <div class="row mt-2 mb-2">
                              ...
                              <div class="row mt-2 mb-2">
                                ...
                                <div class="col-md-4">
                                  <fieldset class="mb-2">
                                    <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hubo novedades con la planta eléctrica? (Si aplica)<span style="color:#FF0000">*</span></b>
                                    </legend>
                                    <div class="form-check form-check-inline">
                                  ...
                                  <div id="plantaGroup" class="mt-2" style="display:none;">
                                    ...
                                    <label for="mant8" class="form-label"><strong>Ingrese las novedades presentadas en la planta eléctrica:</strong></label>
                                ...
                                <div class="col-md-4">
                                  <fieldset class="mb-2">
                                    <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Hay alguna actividad pendiente del
                                        área, ya sea del equipo de Mantenimiento o un contratista?<span
                                          style="color:#FF0000">*</span></b>
                                    </legend>
                                    <div class="form-check form-check-inline">
                            ...
                            <div class="container d-flex row mt-2 mb-2">
                              <div class="form-group col-md-12">
                            ...
                            <div class="row mt-2 mb-2" data-sede="PANCE">
                                <div class="container d-flex justify-content-center" data-sede="PANCE" style="display:none">
                                  <h3>CHETANO</h3>
                                </div>
                                
                                <div class="container d-flex justify-content-center" data-sede="PANCE" style="display:none">
                                  <div class="form-group col-lg-6" data-sede="PANCE">
                                    <label><b><span style="color:#FF0000;">•</span> Novedades Chetano.<span style="color:#FF0000;">*</span></b></label>
                                    <textarea class="form-control" rows="4" name="nov_chetano" required data-sede="PANCE"></textarea>
                                  </div>
                                  <div class="form-group col-lg-6" data-sede="PANCE">
                                    <label><b><span style="color:#FF0000;">•</span> Venta de Productos.<span style="color:#FF0000;">*</span></b></label>
                                    <textarea class="form-control" rows="4" name="ventas_chetano" required data-sede="PANCE"></textarea>
                                  </div>
                                </div>
                                
                                <div class="container d-flex justify-content-center" data-sede="PANCE" style="display:none">
                                  <div class="form-group col-lg-6" data-sede="PANCE">
                                    <label><b><span style="color:#FF0000;">•</span> Venta Domicilios.<span style="color:#FF0000;">*</span></b></label>
                                    <textarea class="form-control" rows="4" name="dom_chetano" required data-sede="PANCE"></textarea>
                                  </div>
                                  <div class="form-group col-lg-6" data-sede="PANCE">
                                    <label><b><span style="color:#FF0000;">•</span> Materias Primas.<span style="color:#FF0000;">*</span></b></label>
                                    <textarea class="form-control" rows="4" name="mp_chetano" required data-sede="PANCE"></textarea>
                                  </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container d-flex justify-content-center col-12">
                            <div class="form-group col-3"><button type="button" id="guardar_local_storage" class="btn btn-secondary btn-block">💾 Guardar Temporal</button></div>
                            <div class="form-group col-3"><button type="button" id="cargar_local_storage" class="btn btn-success btn-block">📂 Cargar Información Temporal</button></div>
                            <div class="form-group col-3"><button type="submit" name="enviar_bitacora" id="enviar_bitacora" class="btn btn-primary btn-block">📨 Enviar Bitácora</button></div>
                            <div class="form-group col-3"><button type="button" id="btn_descargar_pdf" class="btn btn-secondary btn-block">⬇ Descargar PDF</button></div>
                        </div>
                    </form>
      ...
      $('#equipo_bpm').on('change', function () {
        ...
        if (selectedOptions && selectedOptions.length > 0) {
          ...
          function calcularTiempo() {
              ...
              if (diff < 0) {
                  diff += 24 * 60; // suma 24 horas si apagado es al día siguiente
                }
        ...
        document.getElementById('mant6').addEventListener('change', calcularTiempo);
          ...
          $(".form-bitacora").submit(function (event) {
            ...
            //$botonEnvio.prop('disabled', true);
                $.ajax({
                    ...
                    success: function (resp) {
                        ...
                        Swal.fire({
                            icon: resp.ok ? (resp.correoEnviado ? 'success' : 'warning') : 'error',
                            title: resp.ok ? 'Proceso finalizado' : 'Error',
                            text: resp.message || 'La bitácora fue procesada.'
                        });
                    },
                    error: function (xhr, status, error) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'No se pudo procesar la bitácora.'
                        });
                    },
                    complete: function () {
            ...
            // === Habilitar/mostrar campos por sede (genérico) ===
            function toggleCamposPorSede(sedeSeleccionada) {
              $('[data-sede]').each(function () {
                const $el = $(this);
                const sedesAttr = ($el.attr('data-sede') || '').split(',').map(s => $.trim(s.toUpperCase()));
                const permitido = sedesAttr.includes((sedeSeleccionada || '').toUpperCase());
            ...
            // Ejecutar al cargar (por si ya hay una sede seleccionada)
