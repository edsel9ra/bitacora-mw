                    ...
                    <form method="post" class="form-bitacora" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="idSede" class="form-control" name="sede" required>
                                    ...
                                    <option value="UNICENTRO - TRILOGIA" selected>UNICENTRO - TRILOGIA</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>•
                                    </span><b>AFLUENCIA DE
                                ...
                                <div class="col-md-6">
                                  <fieldset class="mb-2">
                                    <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se presentaron novedades con la facturación,
                                         como facturas electrónicas sin CUFE?<span
                                          style="color:#FF0000">*</span></b>
                                    </legend>
                                    <div class="form-check form-check-inline">
                            ...
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="col-md-6">
                                  <fieldset class="mb-2">
                                    <legend class="h6 mb-2"><b><span style="color:#FF0000">•</span>¿Se registraron solicitudes o casos
                                        en HelpDesk para el área de <strong>Sistemas - TI</strong>?<span
                                          style="color:#FF0000">*</span></b>
                                    </legend>
                                    <div class="form-check form-check-inline">
                                  ...
                                  <div id="ti3Group" class="mt-2" style="display:none;">
                                    <label for="ti3" class="form-label"><strong>Ingrese las solicitudes o los casos registrados y/o pendientes para el área:</strong></label>
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b>ÁREA
                                        DE INFRAESTRUCTURA Y MANTENIMIENTO<span style="color:#FF0000"
                                            ;>*</span></b></label>
                                <small class="form-text" style="font-weight:bold;"></small>
                            </div>
                            <div class="row mt-2 mb-2">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b>ÁREA
                                        DE BAR<span style="color:#FF0000" ;>*</span></b></label>
                                <small class="form-text" style="font-weight:bold;"></small>
                            </div>
                            <div class="container d-flex justify-content-center">
                                <div class="col-md-4">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b>
                                        NOVEDADES DOMICILIOS / RAPPI<span style="color:#FF0000" ;>*</span></b></label>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="bar"><b><span style="color:#FF0000" ;>•</span> Ingrese las novedades con
                                        Rappi.<span style="color:#FF0000" ;>*</span></b></label>
                                <textarea class="form-control" rows="3" name="dorp" required></textarea>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="bar"><b><span style="color:#FF0000" ;>•</span> Ingrese las novedades con
                                        domicilios propios.<span style="color:#FF0000" ;>*</span></b></label>
                            ...
                            <div class="container d-flex">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="inputRappi"><b>Número de DomiExpress<span style="color:#FF0000"
                                                ;>*</span></b></label>
                                    <input type="number" min="0" max="100" class="form-control" name="domiexpress"
                                        required>
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="form-group col-lg-6">
                                <label for="bar"><b><span style="color:#FF0000;">•</span> Novedades Chetano.<span style="color:#FF0000;">*</span></b></label>
                                <textarea class="form-control" rows="4" name="nov_chetano" required></textarea>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="bar"><b><span style="color:#FF0000;">•</span> Venta de Productos.<span style="color:#FF0000;">*</span></b></label>
                                <textarea class="form-control" rows="4" name="ventas_chetano" required></textarea>
                            </div>
                        </div>
                        <div class="container d-flex justify-content-center">
                            <div class="form-group col-lg-6">
                                <label for="bar"><b><span style="color:#FF0000;">•</span> Venta Domicilios.<span style="color:#FF0000;">*</span></b></label>
                                <textarea class="form-control" rows="4" name="dom_chetano" required></textarea>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="bar"><b><span style="color:#FF0000;">•</span> Materias Primas.<span style="color:#FF0000;">*</span></b></label>
                                <textarea class="form-control" rows="4" name="mp_chetano" required></textarea>
                            </div>
                        </div>
                        <div class="container d-flex justify-content-center">
                            <h2>EL TORITO</h2>
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="form-group col-lg-6">
                                <label for="bar"><b><span style="color:#FF0000;">•</span> Novedades Torito.<span style="color:#FF0000;">*</span></b></label>
                                <textarea class="form-control" rows="4" name="nov_torito" required></textarea>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="bar"><b><span style="color:#FF0000;">•</span> Venta de Productos.<span style="color:#FF0000;">*</span></b></label>
                                <textarea class="form-control" rows="4" name="ventas_torito" required></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="container d-flex justify-content-center col-12">
                            <div class="form-group col-lg-3"><button type="button" id="guardar_local_storage"
                                    class="btn btn-secondary btn-lg btn-block">💾 Guardar Temporal</button></div>
                            <div class="form-group col-lg-4"><button type="button" id="cargar_local_storage"
                                    class="btn btn-success btn-lg btn-block">📂 Cargar Información Temporal</button></div>
                            <!--<div class="form-group col-lg-3"><button type="button" id="generar-pdf" name="generar-pdf" 
                                    class="btn btn-danger btn-lg btn-block">Generar PDF</button></div>-->
                            <div class="form-group col-lg-3"><button type="submit" name="enviar_bitacora"
                                    id="enviar_bitacora" class="btn btn-primary btn-lg btn-block">📨 Enviar
                                    Bitácora</button></div>
                        </div>
                    </form>
        ...
        $(document).ready(function () {
            ...
            // Agregar listado para SST
              ...
              $(".form-bitacora").submit(function (event) {
                ...
                console.log('Datos a enviar:', $(".form-bitacora").serializeArray());
                
                $.ajax({
                    url: "../scripts/send_trilogia.php",
                    type: "POST",
