                    ...
                    <form method="post" class="form-bitacora" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b>ÁREA DE OPERACIONES<span style="color:#FF0000" ;>*</span></b></label>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b>AFLUENCIA DE COMENSALES<span style="color:#FF0000" ;>*</span></b></label>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleFormControlTextarea1"><span style="color:#FF0000" ;>• </span><b>ÁREA DE INFRAESTRUCTURA Y MANTENIMIENTO<span style="color:#FF0000" ;>*</span></b></label>
                                <small class="form-text" style="font-weight:bold;"></small>
                            </div>
                            <div class="row mt-2 mb-2">
                                <div class="col-md-4">
