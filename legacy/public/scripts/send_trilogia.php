...
if ($_POST) {
    ...
    $fields = [
        ...
        'hielo4', 'hielo5', 'devo', 'tesor1', 'nov_chetano', 'ventas_chetano', 'dom_chetano',
        'mp_chetano', 'nov_torito', 'ventas_torito', 'bpm1', 'bpm2', 'bpm3', 'bpm4', 'bpm5', 'bpm6',
        ...
        'facturas_mesas','facturas_domic','facturas_rappi','bonos_coomeva','reservas_15','mer4',
        'easypedido','tesor2','planta_elect','mant5','mant6','mant7','mant8','hora_entrada','hora_salida'
    ];
    ...
    // --- Equipos de Computo (ti)
    $equipos_ti = $_POST['equipos_ti'] ?? null;
    if ($equipos_ti === 'No') {
        if (!isset($_POST['ti']) || trim($_POST['ti']) === '') {
            $_POST['ti'] = $DEFAULT_TI;
        }
    } elseif ($equipos_ti === 'Si') {
        if (isset($_POST['ti']) && trim($_POST['ti']) === $DEFAULT_TI) {
            $_POST['ti'] = '';
        }
    }
    ...
    $data['fecha'] = date('d-m-Y', strtotime($_POST['fechab']));
        ...
        //Recipients
        $email_list = [
            'unicentro@misterwings.com','admin.unicentro@misterwings.com','coordinador.sistemas@misterwings.com','soporte@misterwings.com',
            ...
            'aux.tesoreria@misterwings.com','aux.contable2@misterwings.com','colquingroup@hotmail.com', 'aux.admin.bochalema@misterwings.com',
            'aux.gestionhumana@misterwings.com', 'coordinador.procesos@misterwings.com','apr.mejoramiento@misterwings.com',
            'director.administrativo@misterwings.com','director.administrativosedes@misterwings.com','asistente.operativo@misterwings.com',
        ...
        '<div class="area-section">
            <div class="area-title">CHETANO</div>
            <div class="stats-section">
        ...
        <div class="area-section">
            <div class="area-title">TORITO</div>
            <div class="stats-section">
                <div class="stat-box"><strong>Novedades Torito: </strong>' . e($data['nov_torito'] ?? '') . '</div>
                <div class="stat-box"><strong>Venta de Productos: </strong>' . e($data['ventas_torito'] ?? '') . '</div>
            </div>
        </div>'.
