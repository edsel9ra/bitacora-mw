<?php
    ...
    if($_POST){
        ...
        'hielo4', 'hielo5', 'devo', 'tesor1', 'bpm1', 'bpm2', 'bpm3', 'bpm4', 'bpm5',
        'bpm6', 'bpm7', 'bpm8', 'equipo_bpm', 'visita_ss', 'visita_dagma', 'visita_west', 'novedad_grameras',
        ...
        'equipos_cocina','equipos_bar','equipos_salon','locativos','pendientes','hielo_produ','hielo_kolbitos',
        'hielo_consumo','hielo_enviado','hielo_recibido','facturas_mesas','facturas_domic','facturas_rappi',
        'bonos_coomeva','reservas_15','mer4','easypedido','tesor2','planta_elect','mant5','mant6','mant7','mant8',
        ...
        if (!$_POST || hasEmptyFields($_POST, $fields)){
            ...
            switch($data['sede']){
                case 'LIMONAR':
                    ...
                    $mail->addAddress('limonar@misterwings.com');
                    break;
                    
                case 'SAN FERNANDO':
                    $mail->addAddress('adminsanfernando@misterwings.com');
                    $mail->addAddress('sanfernando@misterwings.com');
                    break;
            }
            
            $email_list = [
                'coordinador.sistemas@misterwings.com','soporte@misterwings.com','gestionhumana@misterwings.com',
                ...
                'coord.inventarios@misterwings.com','visual@misterwings.com','contabilidad.valquin.les@misterwings.com',
                'comercial@misterwings.com','esquin@hotmail.com','lenisalvaro@hotmail.com',
                'supervisor.comercial@misterwings.com','supervisor.cocinas2@misterwings.com','capacitacionmw@misterwings.com',
                'auxiliar1.sg-sst@misterwings.com','auxiliar.sistemas@misterwings.com','contabilidad-sanfernando@misterwings.com',
                'comercial.gerencia@misterwings.com', 'colquingroup@hotmail.com', 'aux.gestionhumana@misterwings.com',
                'coordinador.procesos@misterwings.com','apr.mejoramiento@misterwings.com','asistente.operativo@misterwings.com',
