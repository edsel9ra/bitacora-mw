...
if ($_POST) {
    ...
    $fields = [
        ...
        'hielo4', 'hielo5', 'devo', 'tesor1', 'bpm1', 'bpm2', 'bpm3', 'bpm4', 'bpm5', 'bpm6', 'bpm7', 'bpm8',
        'equipo_bpm', 'visita_ss', 'visita_dagma', 'visita_west', 'novedad_grameras',
        'equipos_ti', 'facturas_ti', 'novedades_ti', 'casos_ti','accidentes_sst',
        'incapacidades_sst','ambiente_laboral','senal_sst','equipo_sst','entrega_epp',
        'novedades_sst','casos_sst','equipos_cocina','equipos_bar','equipos_salon','locativos',
        'pendientes','hielo_produ','hielo_kolbitos','hielo_consumo','hielo_enviado',
        'hielo_recibido','facturas_mesas','facturas_domic','facturas_rappi','bonos_coomeva',
        'reservas_15','mer4','easypedido','tesor2','planta_elect','mant5','mant6','mant7','mant8',
...
if (!$_POST || hasEmptyFields($_POST, $fields)){
    ...
    $data['fecha'] = date('d-m-Y', strtotime($_POST['fechab']));
        ...
        //Recipients
        $email_list = [
            'granada@misterwings.com','admingranada@misterwings.com','coor.granada@misterwings.com','coordinador.sistemas@misterwings.com','soporte@misterwings.com',
            'subgerente@misterwings.com','coordinadora.sg-sst@misterwings.com','jefegestionhumana@misterwings.com',
            'ambiental@misterwings.com','supervisora.cocinas@misterwings.com','operaciones.supervisor@misterwings.com',
            'coordinador.operaciones@misterwings.com','mejoramiento@misterwings.com','mercadeo@misterwings.com',
            'granada@misterwings.com','gestionhumana@misterwings.com', 'gerencia@misterwings.com','mantenimiento@misterwings.com',
            'auxiliar.sg-sst@misterwings.com', 'coord.inventarios@misterwings.com','visual@misterwings.com','tesoreria@misterwings.com',
            'comercial@misterwings.com','contabilidad@misterwings.com','supervisor.comercial@misterwings.com',
            'supervisor.cocinas2@misterwings.com','capacitacionmw@misterwings.com','auxiliar1.sg-sst@misterwings.com',
            'auxiliar.sistemas@misterwings.com','comercial.gerencia@misterwings.com', 'aux.tesoreria@misterwings.com',
            'colquingroup@hotmail.com','aux.contable2@misterwings.com', 'aux.gestionhumana@misterwings.com',
            'coordinador.procesos@misterwings.com','apr.mejoramiento@misterwings.com','asistente.operativo@misterwings.com','grafica@misterwings.com'
        ];
