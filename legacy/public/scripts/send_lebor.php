...
if($_POST){
    ...
    $fields = [
        ...
        'hielo4', 'hielo5', 'devo', 'tesor1', 'reu', 'bpm1', 'bpm2', 'bpm3', 'bpm4', 'bpm5', 
        ...
        'facturas_domic','facturas_rappi','bonos_coomeva','reservas_15','mer4','easypedido','tesor2',
    ...
    if (!$_POST || hasEmptyFields($_POST, $fields)){
        ...
        //Recipients
        $email_list = [
            'cajallanogrande@misterwings.com','coordinadorllanogrande@misterwings.com','coordinador.sistemas@misterwings.com','soporte@misterwings.com',
            ...
            'mejoramiento@misterwings.com','mercadeo@misterwings.com', 'gerencia@misterwings.com','mantenimiento@misterwings.com',
            'auxiliar.sg-sst@misterwings.com', 'coord.inventarios@misterwings.com','visual@misterwings.com','contabilidad.valquin.les@misterwings.com',
        ...
        // REUNIÓN 3 PM
        '<div class="area-section">
            <div class="area-title">REUNIÓN DE CALIDAD 3:00 P.M.</div>
            <div class="sub-item"><strong>Novedades: </strong>' . e($data['reu'] ?? ''). '</div>
        </div>'.
